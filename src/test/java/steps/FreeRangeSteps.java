...
public class FreeRangeSteps {
    ...
    @When("^(?:I|The user|The client) selects? ver cursos en Udemy$")
    public void SelectUdemy() {
        cursosPage.clickOnVerUdemy();
    }
    ...
    public void validateCheckoutPlans() {
        ...
        List<String> expectedOptions = Arrays.asList("Academia: $16.99 / mes • 14 productos",
